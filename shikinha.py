...
async def help(ctx):
    ...
    embed.add_field(name="play <nome ou link>", value="● Toca uma música a partir de um nome ou link do YouTube.", inline=False)
    ...
    embed.add_field(name="queue", value="● Mostra a fila de músicas atual.", inline=False)
    embed.add_field(name="mp3 <link>", value="● Baixa o áudio do link fornecido e envia como .mp3 (BETA).", inline=False)
